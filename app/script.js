...
function clickedTreatButton() {
	...
	document.getElementById("treats").style.display = "block";
  setTimeout(() => {
		document.getElementById("treats").style.display = "none";
	}, 3150);
  setTimeout(() => {
	...
	setTimeout(() => {
		document.getElementById("charhunger").style.display = "none";
	}, 3150);
	setTimeout(() => {
		document.getElementById("charchar").style.display = "block";
	}, 3150);
	checkAndUpdatePetInfoInHtml();
}
...
function clickedPlayButton() {
  ...
  setTimeout(() => {
	...
	setTimeout(() => {
		document.getElementById("charchu").style.display = "none";
	}, 3150);
	setTimeout(() => {
		document.getElementById("charchar").style.display = "block";
	}, 3150);
...
function clickedExerciseButton() {
  ...
  setTimeout(() => {
	...
	setTimeout(() => {
		document.getElementById("chargif").style.display = "none";
	}, 3300);
	setTimeout(() => {
		document.getElementById("charchar").style.display = "block";
	}, 3300);
...
function clickedStaminaButton() {
  ...
  document.getElementById("box").style.display = "none";
	document.getElementById("heals").style.display = "block";
  setTimeout(() => {
		document.getElementById("heals").style.display = "none";
	}, 5800);
  setTimeout(() => {
		document.getElementById("box").style.display = "block";
	}, 5800);
	...
	setTimeout(() => {
		document.getElementById("pokecenter").style.display = "none";
	}, 5800);
	setTimeout(() => {
		document.getElementById("charchar").style.display = "block";
	}, 5800);
